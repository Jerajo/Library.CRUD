...
namespace Library.Api.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BookStockByEdition",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookEdition = table.Column<int>(type: "int", nullable: false),
                    AvailabeBooks = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookStockByEdition", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookStockByEdition_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookStockByEdition_BookId",
                table: "BookStockByEdition",
                column: "BookId");
        }
